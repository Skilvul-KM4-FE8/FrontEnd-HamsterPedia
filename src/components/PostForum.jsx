...
function PostForum({ refresh }) {
  ...
  const fetchData = async () => {
    axios("https://backend-hamsterpedia.vercel.app/post/allposts?category=General")
  ...
  const handleSubmit = async (e, postId, commentData) => {
    ...
    try {
      ...
      await axios("https://backend-hamsterpedia.vercel.app/post/allposts?category=General")
        .then(result => setCard(result.data));
