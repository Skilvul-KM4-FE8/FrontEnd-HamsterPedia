...
function PostForum({ refresh }) {
  ...
  const fetchData = async () => {
    axios("https://backend-hamsterpedia.vercel.app/post/allposts?category=makanan")
  ...
  const handleSubmit = async (e, postId, commentData) => {
    ...
    try {
      ...
      await axios("https://backend-hamsterpedia.vercel.app/post/allposts?category=makanan")
        .then(result => setCard(result.data));
