...
function PostForumPerawatan({refresh}) {
  // GET POST
  ...
  // POST COMMENT
   ...
                 });
                ...
                await axios("https://backend-hamsterpedia.vercel.app/post/allposts?category=perawatan").then(result => setCard(result.data))
...
export default PostForumPerawatan;