                        ...
                        <div className="card-hemi">
                                <Row>
                                    <div className="col-lg-8" data-aos="zoom-in" data-aos-duration="1000">
                                        <div>
                                            <h4 id="fakta-title">Hamster beradaptasi dengan baik di laboratorium dan menjadi salah satu hewan percobaan yang penting.</h4>
                                                <div className="fakta-detail">
                                                    ...
                                                    <p>Mereka akan tumbuh dengan cepat menggunakan pendekatan standar yang biasa diterapkan pada tikus sebagai hewan percobaan laboratorium, dengan makanan utama berupa pelet tikus yang diberi tambahan campuran biji-bijian seperti gandum, terigu, dan serpihan maizena.</p>
                                    ...
                                    <div className="col-lg-4" data-aos="zoom-in" data-aos-duration="1000">
                                        <div className="gambar-hemi">
                                            <img src={Ilmiah1} className="img-hemi-fakta img-fluid" alt="Responsive Image"/>
                                        </div>
                                    </div>
                                </Row>
                        </div>
