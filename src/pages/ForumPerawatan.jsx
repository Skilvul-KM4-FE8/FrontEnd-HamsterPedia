...
const Forum = () => {
  // const [refreshPostForum, setRefreshPostForum] = useState(false); 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://backend-hamsterpedia.vercel.app/post/addpost",
        {
          method: "POST",
          body: formData,
        }
      ...
      <section>
        ...
        <div className="a-container">
          <Row>
            ...
            >
              <div className="new-post3">Tambahkan Postingan Perawatan</div>
              <div className="app">
            ...
            >
              ...
              >
                <h4>Forum Umum</h4>
                <p class="small">
                  Disini kamu bisa membahas topik umum seputar hamster
                </p>
              ...
              >
                <h4>Forum Makanan</h4>
                <p class="small">
                  Disini kamu bisa membahas topik seputar makanan hamster
                </p>
              ...
              <a
                class="card3"
                href="/forum-perawatan"
                onClick={() => window.scrollTo(0, 0)}
              >
                <h4>Forum Perawatan</h4>
                <p class="small">
                  Disini kamu bisa membahas topik seputar perawatan hamster
                </p>
        ...
        <PostForumPerawatan refresh={newData}></PostForumPerawatan>
      </section>
    </>
  );
};
