                ...
                <div className="a-container" data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <Row>
                        <div className="col-md-8" data-aos="zoom-in" data-aos-duration="1000">
                            ...
                            <p>
                            Jenis kelamin hamster biasanya lebih mudah dilihat ketika sudah berumur 3-4 bulan.
                            Untuk mengetahui jenis kelamin hamster, yang perlu kamu lakukan adalah melihat alat kelaminnya dengan melakukan salah satu cara dari dua cara berikut :
                            <br/>
                                <ul>
                                    <li>Tempatkan hamster pada satu tangan, tempatkan tangan yang lain pada punggung hamster, lalu tidurkan hamster hingga terlentang.   </li>
                                    <li>Pegang hamster pada punduk atau lehernya untuk melihat bagian bawah tubuhnya  </li>
                                </ul>
                            </p>
                        </div>
                    ...
                    <div className="card-betina d-flex align-center justify-center">
                        <div className="card-hemi">
                                ...
                                <h2>Hamster Betina</h2>
                                    ...
                                    <ul>
                                        <li>Terdapat dua lubang di bagian alat kelaminnya, yaitu vagina dan anus yang jaraknya sangat dekat </li>
                                        <li>Memiliki puting susu dibagian bawah badannya sejumlah 4-6 puting susu saat hamster sudah besar  </li>
                                        <li>Bulu dibagian perut lebih sedikit dibanding jantan  </li>
                                    </ul>
                                    </div>
                                </div>
                                <div className="col-md-4" data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <div className="card-jantan d-flex align-center justify-center">
                        <div className="card-hemi">
                                ...
                                <h2>Hamster Jantan</h2>
                                    <div className="hemi-detail">
                                    <ul>
                                        <li>Badan bagian bawah hamster jantan lebih bulat dibanding betina   </li>
                                        <li>Terdapat dua lubang di bagian alat kelaminnya, yaitu penis dan anus yang jaraknya sekitar 1-2cm  </li>
                                        <li>Selain itu hamster jantan memiliki kelenjar bau di sekitar perut yang berbentuk benjolan kecil  </li>
                                        <li>Memiliki bulu yang lebih tebal di area perut dibanding betina  </li>
                                    </ul>
                                    </div>
                                </div>
                                </Row>
